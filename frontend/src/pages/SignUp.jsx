...
export default function SignUp() {
  ...
  return (
    <div className='p-8 max-w-lg mx-auto'>
      <h1 className='text-5xl text-center font-semibold my-7 font-cursive text-purple-900'>Sign Up</h1>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button disabled={loading} className='bg-purple-800 text-white p-3 rounded-lg uppercase hover:opacity-95 disabled:opacity-80 cursor-pointer'>
